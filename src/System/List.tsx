...
import {getDefaultItemForTypeStructure, getValueLabel, TypeStructure, TypeStructureMap,} from './TypeParsing/TypeUtils';
...
export const List: FC<ListProps> = ({
    ...
    const onMoveItems = useCallback(
        (moveItemsToIndex: number) => {
            ...
            const newItems = itemsWithoutSelected.reduce((acc, itm) => itm === targetItem ? [...acc, itm, ...selectedItems] : [...acc, itm];
